...
s = s.replace(anchor, CAP19 + anchor, 1)

old = u'CHAPTERS = {1: CAP1, 2: CAP2, 3: CAP3, 4: CAP4, 5: CAP5, 6: CAP6, 7: CAP7, 8: CAP8, 20: CAP20}'
new = u'CHAPTERS = {1: CAP1, 2: CAP2, 3: CAP3, 4: CAP4, 5: CAP5, 6: CAP6, 7: CAP7, 8: CAP8, 19: CAP19, 20: CAP20}'
assert old in s
s = s.replace(old, new, 1)

oldimg = u""" 21: [('mafalda_naufragando','O naufrágio do Principessa Mafalda em representação de época.')],"""
newimg = (u""" 19: [('princessa_mafalda','O Principessa Mafalda. Saiu de Gênova em 11 de outubro de 1927 com 971 passageiros e 288 tripulantes, e já saiu atrasado.')],\n"""
          u""" 21: [('mafalda_naufragando','O naufrágio do Principessa Mafalda em representação de época.')],""")
assert oldimg in s
s = s.replace(oldimg, newimg, 1)

io.open(SRC, 'w', encoding='utf-8', newline='\n').write(s)
print('CAP19 inserido')
