# -*- coding: utf-8 -*-
"""Capitulo 14 — Os que ja estavam la."""
import io
...
s = s.replace(anchor, CAP14 + anchor, 1)

old = u'9: CAP9, 10: CAP10, 19: CAP19, 20: CAP20}'
new = u'9: CAP9, 10: CAP10, 14: CAP14, 19: CAP19, 20: CAP20}'
assert old in s
s = s.replace(old, new, 1)

io.open(SRC, 'w', encoding='utf-8', newline='\n').write(s)
print('CAP14 inserido')
