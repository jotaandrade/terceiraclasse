...
## 12. 🔎 Pendências de verificação (não alterar o texto até confirmar)

| # | O quê | Onde aparece |
|---|---|---|
| ~~1~~ | ~~*di* × *fu* na carta d'identità de 1940~~ | ✅ **verificado 06.09.2026** |
| ~~2~~ | ~~Rosa registrada como chefe de família~~ | ✅ **CONFIRMADO** pela lista do Alhena (seção 8-A) |
...
| ~~9~~ | ~~O navio já navegava adernado na véspera?~~ | ✅ **CONFIRMADO** por de Rosas, Solk e Lynose (10-C) |
| 10 | 🔴 **A procedência do corpus de depoimentos** — jornal, data, página, ou o site compilador | bloqueia o uso de qualquer citação |

⚠️ O item 3 não é só uma frase: o **capítulo 13 do plano se chama "Escala em Dakar"**. Se a
escala da última viagem foi em São Vicente, o título do capítulo muda.
